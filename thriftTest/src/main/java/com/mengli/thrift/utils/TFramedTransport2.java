...
package com.mengli.thrift.utils;
 ...
 */
public class TFramedTransport2 extends TTransport {
    ...
    public static class Factory extends TTransportFactory {
        ...
        public Factory() {
            maxLength_ = TFramedTransport2.DEFAULT_MAX_LENGTH;
        }
     ...
     */
    public TFramedTransport2(TTransport transport, int maxLength) {
        transport_ = transport;
        maxLength_ = maxLength;
    }

    public TFramedTransport2(TTransport transport) {
        transport_ = transport;
        maxLength_ = TFramedTransport2.DEFAULT_MAX_LENGTH;
    }
