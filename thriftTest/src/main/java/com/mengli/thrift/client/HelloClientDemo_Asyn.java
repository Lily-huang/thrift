 ...
 */
public class HelloClientDemo_Asyn {
    ...
    public static void main(String[] args) {
        HelloClientDemo_Asyn client = new HelloClientDemo_Asyn();
        client.startClient("Lily (" + SERVER_PORT + ":" + HelloClientDemo_Asyn.class.getSimpleName() + ")");
